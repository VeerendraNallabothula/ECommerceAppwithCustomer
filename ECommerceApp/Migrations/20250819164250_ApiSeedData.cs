        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscoutPercentage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDiscoutAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntiatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Electonic items like phones, laptops, etc.", false, "Electonics" },
                    { 2, "Various genres of books", false, "Books" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "DiscoutPercentage", "ImageUrl", "IsAvailable", "Name", "Price", "StockQuanity" },
                values: new object[,]
                {
                    { 1, 1, "Latest model smartphone with advanced features", 10, "https://example.com/images/smartphone.jpg", true, "Smartphone", 699.99m, 50 },
                    { 2, 1, "High performance laptop for gaming and work", 15, "https://example.com/images/laptop.jpg", true, "Laptop", 1299.99m, 30 },
